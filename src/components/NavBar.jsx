        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <a href="#" aria-label="WhatsApp" style={{ display: 'flex', color: 'inherit' }}>
            <svg width="22" height="22" viewBox="0 0 256 256" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
              ...
              <path strokeWidth="18" transform="translate(25, 3) scale(0.88)" d="M92.5,84.5l8.7,8.7a16.1,16.1,0,0,1,1.5,21.3l-10,12.5a69.5,69.5,0,0,0,34.4,34.4l12.5-10a16.1,16.1,0,0,1,21.3,1.5l8.7,8.7a16,16,0,0,1,1,21.8l-7.7,8.6a32.1,32.1,0,0,1-32,8A112.1,112.1,0,0,1,49.2,118.3a32.1,32.1,0,0,1,8-32.1l8.6-7.7A16,16,0,0,1,92.5,84.5Z"></path>
            </svg>
          </a>
        </div>
        <button
